...
namespace blekenbleu
{
	public partial class MIDIio
	{
        ...
        private int gndx = -1, cndx = -1;
        string CurrentCar = null, Gname = "";
		internal static int gCount = 0, pCount = 0;
        internal int slider = -1;
        internal static string Msg = "";
        private readonly double[] SliderFactor = new double[] { 0, 0 };
        private readonly Slim slim = new Slim(that) { };
        readonly List<int> Steps = new List<int>() { };             // for Populate()
